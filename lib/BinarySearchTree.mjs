...
class Node{
    constructor(val) {
        this.data = val
        this.left = null       // Ponteiro para subárvore a esqueda
        this.right = null       // Ponteiro para subárvore a direita
    }
}
...
export class BinarySearchTree {
    ...
    insert(val){
        ...
        // 2 caso: insercao recursiva => poercorre a arvore recursivamente
        // para encontrar a posicao do novo nodo
